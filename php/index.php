...
<html lang="pt-br">
  <head>
	...
	<header id="cabecalho">
		...
		<div class="imagcabecalho"> <img src="images/logo2.png"> </div>
			...
			<ul class="nav justify-content-center">
				...
				<li class="nav-item">
					<a class="nav-link active" href="troca.php">Exercício 1 </a>
				</li>
				
				<li class="nav-item">
					<a class="nav-link" href="aammdd.php">Exercício 2 </a>
				</li>
				
				<li class="nav-item">
					<a class="nav-link" href="reajuste.php">Exercício 3 </a>
				</li>
	...
	<body>
		...
		<table class="table table-hover">
		  ...
		  <tbody>
			<tr>
			  ...
			  <td> <a class="nav-link" href="troca.php">Exercício 1 </a> </td> 
			</tr>
			
			<tr>
			  <th scope="row">2</th>
			  <td>Dia, mês e ano</td>
			  <td> <a class="nav-link" href="aammdd.php">Exercício 2 </a> </td> 
			</tr>
			
			<tr>
			  <th scope="row">3</th>
			  <td> Salário </td>
			  <td> <a class="nav-link" href="reajuste.php">Exercício 3 </a> </td> 
			</tr>
			
			<tr>
			  <th scope="row">4</th>
			  <td> Equaçãp de 2º Grau</td>
			  <td> <a class="nav-link" href="equac.php">Exercício 4</a> </td> 
			</tr>
		...
		<footer id="rodape">
			<p class="text-primary text-center">Direitos Reservados - Bruna, Bruno e Emanuelle</p> 
