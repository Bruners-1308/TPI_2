...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
	...
	<section>
	<p>
		8.	Criar um programa que leia o número inicial e um número final e apresente todas as tabuadas do intervalo
	</p>
	 <form method="POST">
   	
		<label for="depos">Tabuada:</label>
			<input type="text" placeholder="Digite o número inicial" name="inicio" />
			<input type="text" placeholder="Digite o número final" name="final" />
			<br>
